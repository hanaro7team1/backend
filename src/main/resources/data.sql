...
INSERT INTO `Member` (id, memberType, phone, name, villageName, loginId, region, password, role)
VALUES (1, 'ADMIN', '055-000-0000', NULL, '가람마을', 'garam', '경남 창원시',
        '$2a$10$8QZZbiHKpqRxSomOCBzk5u.5z.pwDY2KsU6WksgkNijf9SJ1eIa.6', 'ROLE_ADMIN'),
       (2, 'ADMIN', '055-111-0001', NULL, 'village1', 'host1', 'region1',
        '$2a$10$2YeV0Pto3v0rRbPzWFZhmeSGCBlDaoNWi1CO4.bp8X2xEZ1g.Ie16', 'ROLE_ADMIN'),
       (3, 'ADMIN', '055-111-0002', NULL, 'village2', 'host2', 'region2',
        '$2a$10$7E15DDWiMFllvKxGMMxSWuSOR7iK.crxXRy2de8xqwfQcK9uPDHwu', 'ROLE_ADMIN'),
       (4, 'ADMIN', '055-111-0003', NULL, 'village3', 'host3', 'region3',
        '$2a$10$iszLSp7r1glaWZNWopAHheqa9yANRDVQH1ugwh8VLQOq9wSuaxJmG', 'ROLE_ADMIN'),
       (5, 'USER', '010-2222-0001', 'user1', NULL, 'user1', NULL,
        '$2a$10$x0gzXfsuEifEcNryKKyziegEyGv8gjKU2mp3vGRgEZRd8XEGDImdG', 'ROLE_USER'),
       (6, 'USER', '010-2222-0002', 'user2', NULL, 'user2', NULL,
        '$2a$10$eQjsYpHxhqQdFAxCaN9Au.FN3LcReNarPw3H12FNUum8ekw/F1dq.', 'ROLE_USER'),
       (7, 'USER', '010-2222-0003', 'user3', NULL, 'user3', NULL,
        '$2a$10$WSD7P6LuiRHBYDn2c586m.klElE3OWqaQYQq0oOpuLKPVPXM9Kh1O', 'ROLE_USER'),
       (8, 'USER', '010-2222-0004', 'user4', NULL, 'user4', NULL,
        '$2a$10$zC60dFn4fP114cnq/EAxA.iFI7C5f6aMfhrvZ9A.F2KRJuEv/lYg6', 'ROLE_USER'),
       (9, 'USER', '010-2222-0005', 'user5', NULL, 'user5', NULL,
        '$2a$10$2.yJyXlv.TFhWXtzrkHMUek8MBvOs4qTjUzxfONkPMM6dxblOwpe.', 'ROLE_USER'),
       (10, 'USER', '010-2222-0006', 'user6', NULL, 'user6', NULL,
        '$2a$10$WThORgw/V0qVadA7BdX.EOWrRghxDrnnCmi1vYnacFd063xRbK6/u', 'ROLE_USER'),
       (11, 'USER', '010-2222-0007', 'user7', NULL, 'user7', NULL,
        '$2a$10$T5S6ySXy.3J/WNTOmR6JT.YfalVW059/KjBUD.m/bpEzJuwtC6B1a', 'ROLE_USER'),
       (12, 'USER', '010-2222-0008', 'user8', NULL, 'user8', NULL,
        '$2a$10$4fn5bENTtUprJfYb9Kl.POykH0XfJsHOTVvPZQghJe4FuDY43wODO', 'ROLE_USER'),
       (13, 'USER', '010-2222-0009', 'user9', NULL, 'user9', NULL,
        '$2a$10$hhaiWRVpjkPPLcXvd3TqXe9VfN6PyLk9x88untPA28ZIbAlFL90vG', 'ROLE_USER'),
       (14, 'USER', '010-2222-0010', 'user10', NULL, 'user10', NULL,
        '$2a$10$CK6/X5sc73q1eNtu1GeBtuiUkgk2BevLwvyqGkFB0RSjQRjN8god6', 'ROLE_USER');
